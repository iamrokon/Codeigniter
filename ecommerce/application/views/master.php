      ...
      <li class="side_cart"><span class="icon">Shopping Cart</span>
        <div id="cart">
          ...
          <div class="content">
            ...
            <div class="checkout"><a class="button" href="<>"><span>Checkout</span></a></div>
          </div>
        </div>
      </li>
...
<!--        <li><a href="compare.html">Compare</a></li>-->
      ...
      <div id="welcome"> Welcome <?php echo $this->session->userdata('name')?> you can 
          ...
          {
          ?>
          <a href="<?php echo base_url();?>checkout/logout.html">Logout</a>
          <?php } else{?>
          <?php echo $this->session->unset_userdata('name')?>
          <a href="<?php echo base_url();?>checkout/">login</a> or <a href="<?php echo base_url();?>checkout/">create an account</a>.
          <?php } ?>
      </div>
      <div class="menu">
        <ul id="topnav">
