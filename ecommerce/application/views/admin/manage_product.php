                ...
                <tbody>
                    ...
                    <tr>
                       ...
                       <td class="center"><?php echo $v_product->product_name?></td>
                        <td><?php echo $v_product->product_description?></td>
                        <td><?php echo $v_product->product_price?></td>
                        <td><?php echo $v_product->product_quantity?></td>
                        <td><?php echo $v_product->featured_product?></td>
                        <td class="center">
                            <?php 
                        ...
                        <td class="center">
                            ...
                            {
                            ?>
                            <a class="btn btn-success" href="<?php echo base_url();?>super_admin/unpublished_product/<?php echo $v_product->product_id?>">
                            ...
                            ?>
                            <a class="btn btn-danger" href="<?php echo base_url();?>super_admin/published_product/<?php echo $v_product->product_id?>">
