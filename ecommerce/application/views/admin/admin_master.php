			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="<?php echo base_url();?>super_admin/manage_Manufacturer"><i class="icon-font"></i><span class="hidden-tablet">Manage Manufacturer</span></a></li>
						...
						<li><a class="ajax-link" href="<?php echo base_url();?>super_admin/manage_product"><i class="icon-align-justify"></i><span class="hidden-tablet">Manage Product</span></a></li>
